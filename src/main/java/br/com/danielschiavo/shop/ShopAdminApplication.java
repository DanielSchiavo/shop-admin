...
public class ShopAdminApplication extends SpringBootServletInitializer {
	...
	public static void main(String[] args) throws IOException {
        ...
        String serverPort = props.getProperty("shopadmin.server.port");
        
        String additionalConfig = "classpath:/application-" + activeProfile + "-compartilhado.properties";
        
        new SpringApplicationBuilder(ShopAdminApplication.class)
